...
> "Spec written to `<path>`. Please review it and let me know if you want to make any changes before we continue to interview-plan (or write-plan if there is no ticket)."
