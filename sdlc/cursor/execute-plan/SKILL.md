...
name: execute-plan
description: >-
  Implement a written plan (from write-plan or interview-plan). Use when the
  user says execute or implement the plan. Runs the review gate itself. Do
  not use while still interviewing or writing the plan.
